...
Astronomer.prototype.onpage = function(page) {
...
Astronomer.prototype.onidentify = function(identify) {
...
Astronomer.prototype.ongroup = function(group) {
...
Astronomer.prototype.ontrack = function(track) {
  var json = track.json();
...
Astronomer.prototype.onalias = function(alias) {
  var json = alias.json();
...
Astronomer.prototype.send = function(path, msg, fn) {
  var url = scheme() + '//api.astronomer.io/v1' + path;
  if (this.options.streamName) {
    var qs = "?streamName=" + this.options.streamName;
    url += qs;
  }
  console.log(url, msg);
...
Astronomer.prototype.cookie = function(name, val) {
  // var store = Segment.storage();
  var store = Astronomer.storage();
...
Astronomer.prototype.referrerId = function(query, ctx) {
